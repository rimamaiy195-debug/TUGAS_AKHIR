...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .card {
      ...
      box-shadow: 0 6px 28px rgba(0,0,0,0.1); overflow: hidden;
    }
    ...
    <?php if (!$dibatalkan): ?>
    .icon-wrap { animation: pulse 1.8s infinite; }
    @keyframes pulse {
    ...
    .info-box {
      ...
      font-size: 12.5px; color: #744210; margin-top: 20px;
      line-height: 1.6;
    }
    ...
    .batal-box {
      ...
      border-radius: 10px; padding: 12px 16px;
      font-size: 12.5px; color: #742a2a; margin-top: 20px;
      line-height: 1.6;
    }
  ...
  <?php if (!$dibatalkan): ?>
  <!-- Auto refresh setiap 15 detik cek status -->
  <script>
    let countdown = 15;
    function tick() {
  ...
  <div class="card">
    ...
    <div class="card-top">
      ...
      <div class="no-booking">
        #<?= str_pad($data['id_booking'], 5, '0', STR_PAD_LEFT) ?>
      </div>
    </div>
    ...
    <div class="card-body">
      ...
      <?php if ($dibatalkan): ?>
        <div class="batal-box">
          ✕ Booking ini telah dibatalkan. Jika ada pertanyaan silakan hubungi kami langsung.
        </div>
      <?php else: ?>
        <div class="info-box">
          ⏳ Halaman ini akan otomatis mengecek status setiap 15 detik. Setelah admin mengkonfirmasi, Anda akan langsung diarahkan ke halaman invoice.
        </div>
      <?php endif; ?>
      ...
      <?php if (!$dibatalkan): ?>
        <div class="refresh-note">
          Otomatis cek ulang dalam <span id="cd">15</span> detik...
        </div>
      <?php endif; ?>
