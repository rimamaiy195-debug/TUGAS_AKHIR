  ...
  <style>
    * { 
    ...
    .profile-card {
      ...
      min-height: calc(100vh - 80px); /* sesuaikan 80px = tinggi header kamu */
      display: grid;
...
<div class="profile-card">
  <!-- LEFT -->
  <div class="left">
    <h1>Rafting Singorojo / Arung Jeram<br>Sungai Bodri Singorojo</h1>
    <p>
    ...
    <div class="rating-card">
      ...
      <span class="score"> 4.8 (1.512 ulasan)</span>
